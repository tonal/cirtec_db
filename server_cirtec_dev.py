...
def create_srv():
  ...
  add_get('/cirtec_dev/db/bundle/', _req_db_bundle)
  add_get('/cirtec_dev/db/context/', _req_db_context)
  add_get('/cirtec_dev/db/publication/', _req_db_publication)
  add_get('/cirtec_dev/db/topic/', _req_db_topic)
  add_get('/cirtec_dev/db/ngramm/', _req_db_ngramm)
